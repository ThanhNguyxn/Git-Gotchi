...
const LEGENDARY_SPRITES = {
  // 🦖 MECHA-REX: Chibi Cybernetic T-Rex (green armor, red eye, cute proportions)
  mecha_rex: {
    normal: [
      "            ",
      "    KKKKKK  ",
  ...
  // 🐉 HYDRA: Chibi 3-Headed Dragon (purple/green, cute proportions)
  hydra: {
    normal: [
      "            ",
      " KK  KK  KK ",
  ...
  // 👻 VOID SPIRIT: Chibi Floating Spectre (hooded, glowing eyes, ethereal bottom)
  void_spirit: {
    normal: [
      "            ",
      "   KKKKKK   ",
  ...
  // 🗿 CYBER GOLEM: Chibi Stone Construct (blocky, blue circuit lines)
  cyber_golem: {
    normal: [
      "            ",
      "  KKKKKKKK  ",
